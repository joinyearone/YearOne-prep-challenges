...
from py_actions import post_to_circle, get_post_count, DAILY_SPACE_ID
...
def actions():
    ...
    try:
        ...
        post_num = get_post_count(DAILY_SPACE_ID)

        title, post_body, author_email = format_post_body(topic, post_num)
        
        post_to_circle(DAILY_SPACE_ID, title, post_body, author_email)
